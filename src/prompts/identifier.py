...
以下典型场景供你在判断风险时参考：
- 钻石/宝石：净度、颜色、切工等级别变化 → R02 质量与鉴定标准，通常为 high
- 贵金属：成色/印记标准变化（如 999→足金） → R02，medium
- 鉴定证书：第三方权威认证（GIA/NGTC）改为自认证 → R02，high
- 定制产品：验收期/改款周期缩短 → R01 交付时效，high
- 寄售/代销：结算周期拉长（月结→季结） → R03 付款与结算，high
- 高值货品：运输保险额度降低或范围缩小 → R07 保险与风险承担，high
- 价格条款：新增单方调价权或强制促销 → R09 价格调整机制，high
- 管辖权/仲裁：诉讼地或仲裁规则变更 → R04 违约责任，medium
- 品牌授权：授权范围、区域、期限变化 → R05 知识产权与品牌，high
- 数据条款：客户信息使用范围、保存期限变化 → R10 数据与隐私，high
